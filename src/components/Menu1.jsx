...
export default function Menu1({dropdownId, isMobile}) {
    ...
    return (
        ...
        <li>
            <button id={"dropdownSportButton"+dropdownId} className={`${isMobile ? 'hover:bg-light hover:text-primary w-full px-4 py-2 rounded-xl' : ''} inline-flex items-center cursor-pointer`} type="button">
                Deportes 
